...
getURL = 'https://api.hubapi.com/properties/v1/companies/groups?hapikey=' + FromAPIKey
postURL = 'https://api.hubapi.com/properties/v1/companies/groups?hapikey=' + ToAPIKey
